...
Apple® tools required to build iOS applications only run on the macOS®
operating system on Intel-based Macs. Xcode® 11.0 (the minimum required
version) runs only on a macOS version 10.14.5 (Mojave) or greater, and
includes the iOS 11 SDK (Software Development Kit).  To submit apps to
...
| Code Sign Resource Rules | `--codesignResourceRules`| (Optional) Used to control which files in a bundle should be sealed by a code signature. For more details, read [The macOS Code Signing In Depth article](https://developer.apple.com/library/mac/technotes/tn2206/_index.html#//apple_ref/doc/uid/DTS40007919-CH1-TNTAG206)
...
(Mac®, macOS®, Apple®, Xcode®, App Store℠, iPad®, iPhone®, iPod® and  Finder® are Trademarks of Apple Inc.)
