...
```
    <podspec>
      ...
      <pods use-frameworks="true">
        ...
        <pod name="Foobar1" git="git@github.com:hoge/foobar1.git" />
        <pod name="Foobar2" git="git@github.com:hoge/foobar2.git" branch="next" />
...
target 'HelloCordova' do
	...
	pod 'Foobar1', :git => 'git@github.com:hoge/foobar1.git'
	pod 'Foobar2', :branch => 'next', :git => 'git@github.com:hoge/foobar2.git'
	pod 'FoobarSwift'
end
```
